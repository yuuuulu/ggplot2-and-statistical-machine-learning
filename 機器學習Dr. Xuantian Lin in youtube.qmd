...
noise will lead a situation : each line makes some mistakes
PLA+ the best line(which makes the fewest mistakes) = Pocket
(modify PLA by keeping best weights in pocket)

## Revisit PLA/Pocket

if D is linearly separable, target f may not be a linear function (sampling luck)
if D is not linearly separable, the target function may be linear(noise)
